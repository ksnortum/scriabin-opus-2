# scriabin-opus-2
[LilyPond](https://lilypond.org/) engraving source files used to create Scriabin's Three Pieces, opus 2.
...
The PDF and MIDI files can be created by issuing the following command in the directory this file is in (assuming you have `lilypond` in your PATH variable):
        ...
        lilypond pieces-op2-book.ly

To create a smaller PDF, try:

        lilypond -dno-point-and-click pieces-op2-book.ly

You may also [download the latest release](https://github.com/ksnortum/scriabin-opus-2/releases/latest) to get the compiled PDF and MIDI files.
